...
class Add extends React.Component {
    ...
    render() {
        ...
        <div>
        <div className="add-employ"><h2>أضافة منتسبي المنظمة</h2></div>
         <form className="add">
       <div className="form-group row">
       <div class="col-xs-2">
         <label for="ex1">الاسم الرباعي</label>
         <input className="custom-select" id="ex1" type="text"></input>
       </div>
       <div className="col-xs-2">
       <label for="ex3">الجنسية</label> 
	...
	<option value="HK">هونج كونج الصينية</option>
       ...
       <div className="col-xs-2">
         <label for="ex1">البريد الالكتروني</label>
         <input className="custom-select" id="ex3" type="text"></input>
       </div>
       <div className="col-xs-2">
         <label for="ex1">الهاتف</label>
         <input className="custom-select" id="ex3" type="text"></input>
       </div>
  </div>
   
         {/* <form className="list-group2"> */}
     <div className="form-group row">
       <div class="col-xs-2">
         <label for="ex1">الاسم الرباعي</label>
         <input className="custom-select" id="ex1" type="text"></input>
  ...
  <option value="AW">آوربا</option>
	...
	<option value="HK">هونج كونج الصينية</option>
       ...
       <div className="col-xs-2">
         <label for="ex2">البريد الالكتروني</label>
         <input class="custom-select" id="ex2" type="text"></input>
       </div>
       <div className="col-xs-2">
         <label for="ex3">الهاتف</label>
         <input className="custom-select" id="ex3" type="text"></input>
       </div>
  </div>
  <div className="form-group row">
...
<div className="infromation">
                   <form className="f">
                    <fieldset>
                        ...
                        <legend className="info">    يرفق مع هذ الاستمارة المعلومات الاتية     </legend>
						
                        <li className="info1"> وثيقة مصدقة تؤيد كون المنظمة الاجنبية الأم مسجلة في بلدها كمنظمة غير حكومية وغير ربحية </li>
                        <li className="info1">  صور عن جواز السفر النافذ ووثيقة الاقامة أو سمة الدخول لرئيس فرع لرئيس فرع المنظمة والمنتسبين الاجانب  </li>   
                        <li className="info1">بيان مفصل بالنشاطات التي يسعى فرع المنظمة الاجنبية تنفيذها في العراق</li>                   
                        <li className="info1">النظام الداخلي للمنظمة</li>
                        <li className="info1">تقرير عن نشاطات المنظمة الام خارج العراق</li>
                        <li className="info1">جميع الوثائق المقدمة ضمن الفقرات (1_2_3_4)مترجمة الى اللغة العربية من جهة معتمدة لدى جمعية المترجمين_العراقيين</li>
                        <li className="info1">الفقرة (1)مصدقة من ممثلية العراق في بلد المنظمة الام ومصدقة من وزارة الخارجية العراقية</li>
